...
/*!
\mainpage
- Creating the checker for work with csv tables. This project contain:
- Generator that creates two random tables and file with sets of comands
- Refsol that work with tables on right way
- Run_solution.sh - bash script that runs Refsol and user solution and check results
\author Rybin Aleksandr 1 course 2 half group 6304 FKTI
\date 28.05.2017
\version 4.0
*/

/*!
\defgroup Generate Functions to Generator
*/
...
/*!
\struct
\brief Struct Table for generating data, or read data from tables in Refsols
*/
...
/*!
\struct
\brief Iterator for array of <struct Table>
*/
...
/*!
\brief Generates set of commands from -1 to 6
